...
- [ ] M16 — V3 Phase 0 (docs/ARCHITECTURE_V3.md §7): per-file fallback deleted (extraction refuses without a confirmed roster), absence/integrity flag split, migration `0012` (built; awaiting review)
