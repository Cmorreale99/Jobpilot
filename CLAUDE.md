...
- [ ] M14 — audit Phase 3 tailoring from the ledger: V1 structuring path deleted, uploads in V2 gathering, highlight claim ids + number-factuality gate (built; awaiting review)
