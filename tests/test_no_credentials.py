...
from tests.conftest import APPROVED_FOLDER_ID, FIXTURES_DIR
...
async def test_full_pipeline_runs_without_credentials(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    cv = await build_master_cv_from_drive(client, "user-1", settings)
