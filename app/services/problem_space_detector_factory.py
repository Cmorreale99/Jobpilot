"""Selects the problem-space detector from config (v3.1 Increment 7).
...
from app.domain.problem_space import HeuristicProblemSpaceDetector, ProblemSpaceDetector
...
def create_problem_space_detector(
    ...
    *,
    ...
    return LlmProblemSpaceDetector(llm_client)
